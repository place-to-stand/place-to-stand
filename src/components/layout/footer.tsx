...
export function Footer() {
  ...
  return (
    <footer className='border-t border-border bg-bg-card text-text-muted'>
      <div className='mx-auto flex w-full max-w-content flex-col gap-12 px-6 py-12 md:flex-row md:items-start md:justify-between'>
      ...
      <div className='mx-auto flex w-full max-w-content flex-col gap-12 px-6 pb-12 md:flex-row md:items-start md:justify-between'>
