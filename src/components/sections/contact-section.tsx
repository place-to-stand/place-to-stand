...
export function ContactSection() {
  ...
  return (
    <AnimatedSection
      id='contact'
      className='flex min-h-[100svh] max-w-none flex-col justify-center gap-10 bg-white px-6 py-24'
    >
      <div className='flex flex-col items-center gap-4 text-center'>
        <span className='text-sm font-semibold uppercase tracking-[0.1em] text-ink/60'>
          Book a Call
        </span>
        <h2 className='max-w-5xl text-balance font-headline text-2xl font-semibold uppercase !leading-[.9] text-ink md:text-4xl'>
          Let&apos;s talk
        </h2>
      ...
      <div className='mx-auto flex w-full max-w-3xl flex-col gap-5'>
        <div className='relative w-full rounded-xl border border-ink/10 bg-white/50 p-6'>
          <form
            noValidate
            onSubmit={onSubmit}
