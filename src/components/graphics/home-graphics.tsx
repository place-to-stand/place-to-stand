...
export function SeatsGraphic({ className }: GraphicProps) {
  return (
    <BlueprintGraphic loop='bp-loop-pulse' className={className}>
      ...
      <path
        d='M36 26 L82 26 L82 74 L36 74 L18 50 Z'
      ...
      <path
        d='M48 50 C48 44 54 44 57 50 C60 56 66 56 66 50 C66 44 60 44 57 50 C54 56 48 56 48 50 Z'
...
function ChartGraphic({ className }: GraphicProps) {
  return (
    <BlueprintGraphic loop='bp-loop-pulse' className={className}>
      ...
      />
      <polyline
        points='22,60 40,48 60,40 74,24'
        className='bp-line stroke-accent'
        strokeWidth='2'
        strokeLinejoin='round'
        strokeLinecap='round'
  ...
  return (
    <BlueprintGraphic loop='bp-loop-scan' className={className}>
      ...
      <line
        ...
        x2='70'
        y2='36'
        className='bp-fx bp-scan stroke-accent'
        strokeWidth='1.5'
        strokeLinecap='round'
      />
...
export function PrototypeGraphic({ className }: GraphicProps) {
  return (
    <BlueprintGraphic loop='bp-loop-pulse' className={className}>
      ...
      />
      <path
        d='M43 21 V42 L31 70 Q31 78 39 78 H61 Q69 78 69 70 L57 42 V21'
        className='bp-line stroke-line'
        strokeWidth='2'
        fill='none'
        strokeLinejoin='round'
